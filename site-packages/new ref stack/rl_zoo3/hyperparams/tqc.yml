...
#   n_timesteps: !!float 5000000.0
#   normalize: True
#   policy: 'MultiInputPolicy'
#   policy_kwargs: "dict(net_arch=[256, 256, 256], n_critics=2, n_quantiles=25, use_sde=False)"
...
#   normalize: True
#   policy: 'MultiInputPolicy'
#   policy_kwargs: "dict(net_arch=[400, 400, 400], n_critics=2, n_quantiles=25, use_sde=False)"
#   replay_buffer_class: HerReplayBuffer
#   replay_buffer_kwargs: "dict(
#     goal_selection_strategy='future',
#     n_sampled_goal=4
...
PandaPickAndPlaceDense-v3:
  ...
  normalize: True
  policy: 'MultiInputPolicy'
  policy_kwargs: "dict(net_arch=[512, 512, 512], n_critics=4, n_quantiles=25)"
  replay_buffer_class: HerReplayBuffer
  replay_buffer_kwargs: "dict(
    goal_selection_strategy='future',
    n_sampled_goal=4
